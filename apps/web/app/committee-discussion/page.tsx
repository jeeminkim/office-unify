...
import { CommitteeDiscussionClient } from "./CommitteeDiscussionClient";

export default async function CommitteeDiscussionPage() {
  ...
  if (!user) {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-lg flex-col justify-center gap-4 p-8 text-slate-800">
        <h1 className="text-xl font-bold">투자위원회 토론</h1>
        <p className="text-sm text-slate-600">
          이 페이지는 Google 로그인 후에만 사용할 수 있습니다.
        </p>
        <GoogleSignInButton redirectTo="/committee-discussion" />
